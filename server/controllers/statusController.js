...
statusController.getAll = async (req, res, next) => {
  ...
  try {
    ...
    return next({ log: `Error caught in statusController.getAll ${error}`,
    status: 404,
...
statusController.getArchived = () => {
  ...
  try {
    ...
    return next({ log: `Error caught in statusController.getArchived ${error}`,
    status: 404,
...
statusController.updateStatus = () => {
  ...
  try {
    ...
    return next({ log: `Error caught in statusController.updateStatus ${error}`,
    status: 400,
...
statusController.deleteStatus = () => {
  ...
  try {
    ...
    return next({ log: `Error caught in statusController.deleteStatus ${error}`,
    status: 404,
